...
class PlotUserSelectiveCoordinatesHidingDistribution:
    ...
    def plot_data(self, pdf_file, image_filename):
        ...
        P.xlabel('Selectively Non Geotagged tweet percentage')
...
def main():
    plotter = PlotUserSelectiveCoordinatesHidingDistribution('/home/himanshu/data/stats/user_selective_coordinate_sharing')
    plotter.plot_data('selective_coordinate_sharing', 'selective_coordinate_sharing.png')
