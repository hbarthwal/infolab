...
class MRUserHomeLocationSharingDistribution(MRJob):
    '''
    Generates a distribution of users and
    home location sharing behavior in a given dataset
    generated by dataextractor.TweetParser .
    '''
    def configure_options(self):
        super(MRUserHomeLocationSharingDistribution, self).configure_options()
    ...
    def load_options(self, args):
        super(MRUserHomeLocationSharingDistribution, self).load_options(args)
    ...
    def yield_data(self, data):
        if data['l'] != '':
            yield 'Users_Sharing_Home_Location', 1
        else:
            yield 'Users_Not_Sharing_Home_Location', 1
...
def main():
    MRUserHomeLocationSharingDistribution.run()
