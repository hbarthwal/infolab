...
from common_functions import SelectiveCoordinateHiding, CoordinatesSharing, Utils
from settings import jobsettings
from cjson import decode

class MRUserSelectiveCoordinatesHidingDistribution(MRJob):
    '''
    ...
    def configure_options(self):
        super(MRUserSelectiveCoordinatesHidingDistribution, self).configure_options()
    ...
    def load_options(self, args):
        super(MRUserSelectiveCoordinatesHidingDistribution, self).load_options(args)
    ...
    def get_index(self, checkins):
        return SelectiveCoordinateHiding.get_index(checkins)

    def steps(self):
        #  Here we use all the methods from the base class
...
def main():
    MRUserSelectiveCoordinatesHidingDistribution.run()
