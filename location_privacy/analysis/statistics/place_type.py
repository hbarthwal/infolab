...
class MRPlacesTypeDistribution(MRJob):
    '''
    Generates a distribution of places based on the
    place_type in a given dataset
    generated by dataextractor.TweetParser .
    '''

    def configure_options(self):
        super(MRPlacesTypeDistribution, self).configure_options()
    ...
    def aggregate_data(self, place_type, count):
        yield place_type, sum(count)
